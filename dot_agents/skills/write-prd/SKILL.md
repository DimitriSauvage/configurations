---
name: write-prd
description: Use when user needs to generate a comprehensive Product Requirements Document (PRD) in Markdown, detailing user stories, acceptance criteria, technical considerations, and metrics. Optionally create GitHub issues upon user confirmation.
---
...
After generating the PRD, ask if the user wants to proceed with creating GitHub issues for the user stories. If they agree, create them and provide the links.
